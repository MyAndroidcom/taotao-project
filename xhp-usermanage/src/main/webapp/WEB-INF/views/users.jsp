...
<div id="userAdd" class="easyui-window" title="新增会员" data-options="modal:true,closed:false,iconCls:'icon-save',href:'/rest/user/page/add'" style="width:800px;height:600px;padding:10px;">
        The window content.
</div>
